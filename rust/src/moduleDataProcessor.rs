...
pub fn get_FA18_UFC_PACKAGE(values: &HashMap<u16, [u8; 2]>) -> UFC_PACKAGE{

    let odu_1_string = get_string_by_addr_and_len(values, 0x7432, 4);
    let odu_2_string = get_string_by_addr_and_len(values, 0x7436, 4);
    let odu_3_string = get_string_by_addr_and_len(values, 0x743a, 4);
    let odu_4_string = get_string_by_addr_and_len(values, 0x743e, 4);
    let odu_5_string = get_string_by_addr_and_len(values, 0x7442, 4);

    let is_odu_1_selected = get_value_by_address(values, 0x7428)[0] == 58;
    ...
    let scratchpad_string_1 = get_string_by_addr_and_len(values, 0x744e, 2);
    let scratchpad_string_2 = get_string_by_addr_and_len(values, 0x7446, 8);
    let area_1_string_1 = scratchpad_string_1.as_bytes();
    let area_1_string_2 = scratchpad_string_2.as_bytes();
    let area_1_0 = area_1_string_1[0] as char;
    let area_1_1 = area_1_string_1[1] as char;

    let area_1_2 = area_1_string_2[0] as char;
    let area_1_3 = area_1_string_2[1] as char;
    let area_1_4 = area_1_string_2[2] as char;
    let area_1_5 = area_1_string_2[3] as char;
    let area_1_6 = area_1_string_2[4] as char;
    let area_1_7 = area_1_string_2[5] as char;
    let area_1_8 = area_1_string_2[6] as char;

    let comms_left =  get_string_by_addr_and_len(values, 0x7424, 2).as_bytes()[1] as char;
    let comms_right =  get_string_by_addr_and_len(values, 0x7426, 2).as_bytes()[1] as char;
...
pub fn get_AV8B_UFC_PACKAGE(values: &HashMap<u16, [u8; 2]>) -> UFC_PACKAGE{
    ...
    let area_1_string = scratchpad_string.as_bytes();
